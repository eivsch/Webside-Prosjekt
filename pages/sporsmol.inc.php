...
<p><span class="oblig">*</span>Obligatoriske felt</p>
    <form  action="" method="POST">
        <fieldset>
            ...
            <p id="bekreft"><label for="check">Bekreft opplysningene</label><span class="oblig">*</span></p>
            <input class="kategori" type="checkbox" name="sjekk" id="check" value="sjekket"/>
            <input class="buttonStyle" id="submit" type="submit" name="send" value="Send" tabindex="7"/>
    </form>
            </div>
    <?php
   ...
   if(isset($_POST["sjekk"]) and isset($_POST["send"])){
       ...
       elseif(!isset($_POST["sjekk"]) and isset($_POST["send"])){
          echo "<span class='error'>$sjekkErr</span></section> </section>";
   }
