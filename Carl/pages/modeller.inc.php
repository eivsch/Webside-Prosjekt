...
<html>
  <head>
	...
	<link rel="stylesheet" title="main" type="text/css" href="pages/sideStil1.css">
	...
	<script charset="utf-8" src="pages/scriptES.js"></script>
  </head>
  <body id="alpha">
    <article>
	  ...
	  <section id="models" role="main" aria-label="info/modeller">
		...
		<div class="outer" id="first">
		  <div id="inner1">
		    <h3>Cube</h3>
			<img src="pages/cube.jpg" alt="Printer nr1" width="155" id="printer1">
		  </div>
		...
		<div class="outer" id="second">
		  <div id="inner2">
		    <h3>BFB 3Dtouch</h3>
		    <img src="pages/3dprinter_0.jpg" alt="Printer nr2" width="155" id="printer2">
		  </div>
		...
		<div class="outer" id="third">
		  <div id="inner3">
		    <h3>RepRap</h3>
			<img src="pages/reprap.jpg" alt="Printer nr3" width="155" height="130" id="printer3">
		  </div>
		...
		<div class="outer" id="fourth">
		  <div id="inner4">
		    <h3>ProJet 660</h3>
			<img src="pages/projet660.jpg" alt="Printer nr4" width="155" height="130" id="printer4">
		  </div>
		...
		<div class="outer" id="fifth">
		  <div id="inner5">
			...
			<img src="pages/printrbot.jpg" alt="Printer nr5" width="155" height="130" id="printer5">
		  </div>
		...
		<div class="outer" id="sixth">
		  <div id="inner6">
		    <h3>Form1</h3>
			<img src="pages/form1.png" alt="Printer nr6" width="155" height="130" id="printer6">
		  </div>
